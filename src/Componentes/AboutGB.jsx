        ...
        <>
            <div className="card text-center" style={{ color: 'white', height: '100%' }}>
                <div className="card-body d-flex flex-column align-items-center justify-content-center">
                    ...
                    Where I am in charge of the design and creation of views, unification of the Front End and Back End, API consumption and manipulation
                    of data in various formats (tables, graphs, reports, etc.), usually in CRM-type projects and Call Center Scripts.
                    <br />
                    I also provide support to the back area, helping with tasks
                    database maintenance (SQL), Endpoint creation (C#) and automation and OCR tasks (Python).
