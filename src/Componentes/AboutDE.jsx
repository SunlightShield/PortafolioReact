    ...
    return (
        <>
            <div className="card-body" style={{ color: "white" }}>
                Ich bin ein Front-End-Entwickler und habe 2022 meinen Abschluss an der Inacap Technological University gemacht. <br />
                ...
                von Daten in verschiedenen Formaten (Tabellen, Grafiken, Berichte usw.). Außerdem unterstütze ich den Rückenbereich und helfe bei Aufgaben
