                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h1 class="modal-title fs-5" id="exampleModalLabel">Ruleta al Azar</h1>
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="button" class="btn btn-primary" onClick={openOtherPage}>Ir a la pagina</button>
                        </div>
                    </div>
                </div>
            </div>
