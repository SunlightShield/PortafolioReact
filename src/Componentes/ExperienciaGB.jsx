        ...
        <>
            <div className="card text-center" style={{ color: 'white', height: '100%' }}>
                <div className="card-body d-flex flex-column align-items-center justify-content-center">
                    ...
                    <br />
                    I also supported the back team, assisting with basic tasks using Firebase and ensuring correct use of SEO.
                    <br />
                    <br />

                    I am currently working at the company Softeck, as a member of the Front End team, where I am in charge of the design and creation of the
